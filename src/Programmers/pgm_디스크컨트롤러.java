...
// TODO: 2023/08/23 프로그래머스 42627번 디스크컨트롤러 (힙[Heap]) https://school.programmers.co.kr/learn/courses/30/lessons/42627
// TODO: 2023/08/23 성공! 
public class pgm_디스크컨트롤러 {
    public static void main(String[] args) throws IOException {
        Solution solution = new Solution();
        int solution1 = solution.solution(new int[][]{{0, 3},{1,2}, {1, 9}, {2, 6}});
